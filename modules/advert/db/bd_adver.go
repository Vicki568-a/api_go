...
import (
	"errors"
	"fmt"
	"github.com/zhashkevych/todo-app/modules/advert"
...
func (d *db) Create(ctx context.Context, user advert.Advert) (string, error) {
...
func (d *db) FindAll(ctx context.Context) (user_user []advert.Advert, err error) {
...
func (d *db) FindOne(ctx context.Context, id string) (user_user advert.Advert, err error) {
...
func (d *db) Update(ctx context.Context, user advert.Advert) error {
...
/*конструктор */
func NewStorage(database *mongo.Database, collection string, logger loging.Logger) advert.Storage {
